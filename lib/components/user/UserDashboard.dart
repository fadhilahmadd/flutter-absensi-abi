...
class UserDashboard extends StatefulWidget {
  ...
  const UserDashboard({Key? key, required this.username, required this.userId})
      : super(key: key);
...
class _UserDashboardState extends State<UserDashboard> {
  ...
  Future<String> fetchUsersName(int userId) async {
    try {
  ...
  void initState() {
    ...
    _getCurrentPosition();
    _updateTime();
    fetchUsersName(widget.userId).then((nama) {
      setState(() {
        nama = nama;
      });
    });
